...
function oddChecker(num){
	if (num%2!==0){ return 'the number is odd'}else{
...
//  Inside of the bigOrSmall function, create a new array called 'answers'. Then, loop over the passed in arr parameter, and check to see if the number in the array is GREATER than 100. If it is, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the answers array. Return the answers array inside of the function.
...
// create an empty array called 'reversed'. Using a for loop, loop over the passed in 
// array IN REVERSE (this means your counter should decrement), 
...
myNumbers.forEach(function(el,i,arr){
	myNumbersIndex=myNumbers.push(i);
  myNumbers.shift(i)
...
const enemies=people.filter(function(el,i){
...
const totallyAwesome=people.reduce(function(acc,el){
